...
$.extend($.validator, {
	...
	messages: {
		...
		kor: "한글만 입력가능합니다.",
		eng: "영문만 입력가능합니다.",
		kor_eng : "한글/영문만 입력가능합니다.",
		ub_all: "-_외 특수문자와 한글은 입력할 수 없습니다.",
		special_one: "특수문자/영문/숫자 각 1자이상 포함하여야 합니다.",
		number: "숫자만 입력해 주세요.",
		digits: "숫자만 입력해 주세요.",
	...
	methods: {
		...
		ub_all: function(value, element) {
			return this.optional(element) || /^[_a-zA-Z0-9-]+$/.test(value);
		},
		special_one: function(value, element) {
			var flag = false;
			var re1 = /[a-zA-Z]/i; // 영문
			var re2 = /[0-9]/i; // 숫자
			var re3 = /[\~'@!#\$\^%&*()+=\-\[\]\\\';,\.\/\{\}\|\":<>\?]/i; // 특수기호
