...
<article>
	...
	<h3 class="log_h3"><img src="../common/images/txt/h3_machin_01.gif" alt="신규기기"><span>(총 00 대) </span></h3>
	<table class="mt10">
		<colgroup>
			<col style="width:16%">
			<col style="width:16%">
		...
		<tbody>
			<tr>
				...
				<td>2BUA01</td>
				<td>192.168.0.100</td>
				<td>44-87-FC-7A-D3-8C</td>
				<td>WinXP</td>
				<td>2012:09.10 12:13:14</td>
			</tr>
		</tbody>
	</table>

	<h3 class="log_h3"><img src="../common/images/txt/h3_machin_02.gif" alt="제외기기"><span>(총 00 대) </span></h3>
	<table class="mt10">
		<colgroup>
			<col style="width:16%">
			<col style="width:16%">
	...
	<h3 class="log_h3"><img src="../common/images/txt/h3_machin_03.gif" alt="운영기기"><span>(총 00 대) </span></h3>
	<table class="mt10">
		<colgroup>
			<col style="width:16%">
			<col style="width:16%">
