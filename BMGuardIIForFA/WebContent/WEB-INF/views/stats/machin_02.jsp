...
<article>
	...
	<section class="tab">
	<ul>
		<li><a href="machin_01.html" class="pass"><span></span><p>자동화기기 운영현황(통계)</p></a></li>
		<li class="on"><a href="machin_02.html" class="pass"><span></span><p>자동화기기 운영현황(기기현황)</p></a></li>
	</ul>
	</section>
	...
	<div class="log_select">
		<ul>
			...
			<li class="type2"><input type="checkbox"> <label for="#">3층기계실</label></li>
			<li class="type3"><input type="checkbox"> <label for="#">가류공정</label></li>
			<li class="type4"><input type="checkbox"> <label for="#">검사공정</label></li>
			<li class="type5"><input type="checkbox"> <label for="#">기타공정</label></li>
			<li class="type6"><input type="checkbox"> <label for="#">반제품공정</label></li>
			<li class="type6"><input type="checkbox"> <label for="#">성형</label></li>
			<li class="type6"><input type="checkbox"> <label for="#">자동창고</label></li>
			<li class="type6"><input type="checkbox"> <label for="#">정련</label></li>
			<li class="type6"><input type="checkbox"> <label for="#">중간검사실</label></li>
		</ul>
	</div>

	<h3 class="log_h3"><img src="../common/images/txt/h3_device.gif" alt="기기선택"><span><!-- 권한 : 제어 및 모니터링 --></span></h3>
	<div class="log_select">
		<ul>
			<li class="type1">
				<select name="" id="">
					<option value="전체" selected>전체</option>
					<option value="신규기기">신규기기</option>
					<option value="제외기기">제외기기</option>
					<option value="운영기기">운영기기</option>
				</select>
			</li>
	...
	<p class="btn_center">
		<a href="machin_02_result.html"><img src="../common/images/btn/btn_check_02.gif" alt="조회"></a>
	</p>
	</section>
</article>
