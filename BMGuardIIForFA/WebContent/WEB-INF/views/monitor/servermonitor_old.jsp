...
$(function () {
    ...
    $.plot($("#placeholder"), [ [0,0] ], options);
    
	 $.PeriodicalUpdater({
	      url : '/RandomNumber.html',
	      method:'get',
	      minTimeout: 3000
	   },
	   function(rtnData){
	    ...
	    //    	data = data.slice(1);
		    ...
		    var arrs = eval("("+rtnData+")");
		    var tranData = arrs.data;
			data.push(tranData[0]);
			plotDraw();
	   		
			var htmls ="";
			htmls += "<tr><td>" + tranData[1]+ "</td>";
			htmls += "<td>" + tranData[0]+ "</td></tr>";
			$("#tranTbody").append(htmls);
	   });
 	...
 	function plotDraw() {
        ...
        for (var i = 0; i < data.length; ++i) {
      	...
      	//setTimeout(plotDraw, 500);
    }
 	
 	function dataInit() {
 		if (data.length > 0)
        	data = data.slice(1);
 		setTimeout(dataInit, 5000);
 	}
	
 	//plotDraw();
 	setTimeout(dataInit, 20000);
