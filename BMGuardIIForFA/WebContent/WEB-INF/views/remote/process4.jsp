...
<nav class="tab_1depth">
	<ul>
		...
		<li class="on"><a href="./process4.html">서비스 시작</a></li>
			...
			<tbody>
				<tr>
					...
					<td class="detail" style="border: 0px; ">
						...
						※ 시작시킬 서비스명 입력 [예) MyService]
					</td>
				</tr>
				<tr>
					<th><label for="sau">서비스 시작 사유</label></th>
	...
	//노드 클릭
	 $("#tree_device_list a").live("click", function(e) {
		...
		$("#submitBtn").click(function() {  
			...
			/* document.BMSupoAx.StartService(IP, port, 서비스 시작 , 클라이언트 idx)*/
			for(var i = 0 ; i < device_idxs.length;i++) {
				...
				document.BMSupoAx.StartService( device_ip, 7997, service, device_idx);
