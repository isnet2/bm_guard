				...
				<tr>
					...
					<td class="bl" style="border-bottom: 0px;">
						<select name="job_type" id="job_type">
							...
							<option value="NE">정상종료</option>
							<option value="NR">정상리부팅</option>
							<option value="FE">강제종료</option>
							<option value="FR">강제리프팅</option>
						</select>
