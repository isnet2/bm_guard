...
<c:set var="gnb4_8" value="on" />
<c:set var="gnb" value="원격관리" />
<c:set var="tab_1d" value="자동화기기 종료관리" />
...
<!-- <nav class="tab_1depth">
	<ul>
		<li class="on"><a href="./pc_end.html">자동화기기 종료관리</a></li>
	</ul>
</nav> -->
</header>
...
<article>
	...
	<div class="board">
		<div class="table_body file_table">
			<table>
				<colgroup>
			...
			<tbody>
				<tr>
					<th>종료유형</th>
					<td class="bl" style="border-bottom: 0px;">
						<select name="#" id="#">
							<option value="정상종료">정상종료</option>
							<option value="정상리부팅">정상리부팅</option>
							<option value="강제종료">강제종료</option>
							<option value="강제리프팅">강제리프팅</option>
						</select>
					</td>
				</tr>
				<tr>
					<th><label for="sau">종료사유</label></th>
					<td style="border-bottom: 0px;">
						<input type="text" style="width:630px" id="sau" name="" /> <a href="#" class="btn type2 set25 btn_action"><span>실 행</span></a>
					</td>
				</tr>
			</tbody>
		</table>
...
$(document).ready(function() {
	...
	$("#helpBtn4").click(function(e){
		helpPopup(e.clientX, e.clientY, "/help.html#help4-5");
		//e.preventDefault();
		return false;
	});
