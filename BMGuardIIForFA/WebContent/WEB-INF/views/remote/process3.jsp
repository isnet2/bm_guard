...
<c:set var="tab_1d" value="프로세스 상태검사" />
...
<nav class="tab_1depth">
	<ul>
		...
		<li class="on"><a href="./process3.html">서비스 상태검사</a></li>
			...
			<tbody>
				<tr>
					...
					<td class="detail" style="border: 0px; ">
						...
						<br><br>※ 상태검사할 서비스명 입력 [예) MyService]
					</td>
				</tr>
			</tbody>
		</table>
	 ...
	 $("#tree_device_list a").live("click", function(e) {
		...
		$("#submitBtn").click(function() {  
			...
			if(device_idxs.length == 0) {
				alert("서비스 상태를 검사할 자동화 기기를 선택하여 주세요.");
				return;
			}
