...
<c:set var="tab_1d" value="파일수신" />
<%@ include file="../common/inc/header.jsp" %>
<!--
<?php 
$body="lnb_tree";
$gnb4="active"; //GNB_1depth
$gnb4_2="on"; //GNB_2depth
$gnb="원격관리";
$gnb_sub="파일/폴더관리";
$tab_1d="파일수신";
...
<nav class="tab_1depth">
	<ul>
		...
		<li class="on"><a href="./file2.html">파일수신</a></li>
		<li><a href="./file3.html">파일삭제</a></li>
...
<article>
	...
	<div class="board">
		...
		<table>
			...
			<tbody>
				<tr>
					<th><label for="forname">가져올 파일</label></th>
					<td class="detail" style="border: 0px;">
						<input type="text" style="width:630px" id="transfile" name="transfile" />
						<input type="hidden" id="job_idx" name="job_idx" />
						 <br/><br/><span style="">※ 가져올 파일의 Full Path 입력 [예)c:\Folder\file.txt]</span>
					</td>
				</tr>
				<tr>
					...
					<td class="detail" style="border: 0px;">
						...
						<!-- <a href="#" id ="submitBtn" class="btn type2 set25"><span>저장할 폴더지정</span></a>
						<span>* 가져올 파일을 저장할 폴더의 Full Path 입력 (예)c:\Folder\file.txt</span> -->
					</td>
				</tr>
				<tr>
					<th><label for="sau">파일 수신 사유</label></th>
					<td class="detail" style="border: 0px;">
...
$(document).ready(function() {
	...
	$("#submitBtn").click(function() {  
		...
		if(device_idxs.length == 0) {
			alert("파일을 수신할 자동화 기기를 선택하여 주세요.");
			return;
		}
		...
		/* document.BMSupoAx.RecvFile(보낼IP, port, 전송파일경로, 수신파일경로, 0, 클라이언트 idx)*/
 ...
 */			alert("("+device_ip +", 7997 ," +transfile+","+savePath+","+ 0 +"," +device_idx+" )");
			document.BMSupoAx.RecvFile( device_ip, 7997,  transfile , savePath, 0, device_idx);
