...
<c:set var="tab_1d" value="레지스트리 삭제" />
...
<nav class="tab_1depth">
	<ul>
		...
		<li class="on"><a href="./registry4.html">레지스트리 삭제</a></li>
	</ul>
</nav>
</header>
...
$(document).ready(function() {
	...
	$("#submitBtn").click(function() {  
		...
		if(device_idxs.length == 0) {
			alert("레지스트리를 삭제할 자동화 기기를 선택하여 주세요.");
			return;
		}
		...
		/* document.BMSupoAx.DelRegistry (IP, port, 키, 서브키,데이터 타입, 값이름, 클라이언트 idx)*/
...
/* 			if(device_ip == "" || device_ip == "null") {
			...
			document.BMSupoAx.DelRegistry( device_ip, 7997, key, sub_key, data_type, data_name, device_idx);
