...
<c:set var="tab_1d" value="레지스트리 추가" />
...
<nav class="tab_1depth">
	<ul>
		...
		<li class="on"><a href="./registry2.html">레지스트리 추가</a></li>
...
$(document).ready(function() {
	...
	$("#submitBtn").click(function() {  
		...
		if(device_idxs.length == 0) {
			alert("레지스트리를 추가할  자동화 기기를 선택하여 주세요.");
			return;
		}
		...
		/* document.BMSupoAx.AddRegistry (IP, port, 키, 서브키,데이터 타입, 값이름, 데이터값,  클라이언트 idx)*/
...
/* 			if(device_ip == "" || device_ip == "null") {
			...
			document.BMSupoAx.AddRegistry( device_ip, 7997, key, sub_key, data_type, data_name, data_val, device_idx);
